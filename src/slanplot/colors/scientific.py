...
bilbao_map = LinearSegmentedColormap.from_list('bilbao', bilbao_data)
bilbao = bilbao_map
try:
    plt.colormaps.register(cmap=bilbao_map, name='bilbao')
except ValueError:
    pass  # Already registered

# bilbaoS
bilbaoS_data = [[0.97444, 0.97436, 0.97404],      
           [0.30038, 0.0018649, 0.005395],      
           [0.66363, 0.52013, 0.39457],      
           [0.57462, 0.29121, 0.27658],      
           [0.75309, 0.72739, 0.63056],      
           ...
           [0.30961, 0.0099596, 0.017575],      
           [0.86668, 0.86453, 0.85655]]
bilbaoS_map = LinearSegmentedColormap.from_list('bilbaoS', bilbaoS_data)
bilbaoS = bilbaoS_map
try:
    plt.colormaps.register(cmap=bilbaoS_map, name='bilbaoS')
except ValueError:
    pass  # Already registered

# imola
imola_data = [[0.10144, 0.20011, 0.70019],      
...
imola = imola_map
try:
    plt.colormaps.register(cmap=imola_map, name='imola')
except ValueError:
    pass  # Already registered

# imolaS
imolaS_data = [[0.10144, 0.20011, 0.70019],      
           [1, 0.99999, 0.40009],      
           [0.32573, 0.52308, 0.4989],      
           [0.5672, 0.76625, 0.43431],      
           [0.18851, 0.36819, 0.61498],      
           ...
           [0.88445, 0.96083, 0.40052],      
           [0.11744, 0.22819, 0.68643]]
imolaS_map = LinearSegmentedColormap.from_list('imolaS', imolaS_data)
imolaS = imolaS_map
try:
    plt.colormaps.register(cmap=imolaS_map, name='imolaS')
except ValueError:
    pass  # Already registered

# vik
vik_data = [[0.0013282, 0.069836, 0.37953],      
...
vik = vik_map
try:
    plt.colormaps.register(cmap=vik_map, name='vik')
except ValueError:
    pass  # Already registered

# cork
cork_data = [[0.1709, 0.099347, 0.29895],      
...
cork_map = LinearSegmentedColormap.from_list('cork', cork_data)
cork = cork_map
try:
    plt.colormaps.register(cmap=cork_map, name='cork')
except ValueError:
    pass  # Already registered
...
batlow = batlow_map
try:
    plt.colormaps.register(cmap=batlow_map, name='batlow')
except ValueError:
    pass  # Already registered

# batlowS
batlowS_data = [[0.0051932, 0.098238, 0.34984],      
           [0.98135, 0.80041, 0.98127],      
           [0.51125, 0.5109, 0.1933],      
           [0.1333, 0.37528, 0.3794],      
           [0.9507, 0.61665, 0.42862],      
           ...
           [0.82547, 0.57773, 0.2642],      
           [0.037449, 0.15831, 0.36022]]
batlowS_map = LinearSegmentedColormap.from_list('batlowS', batlowS_data)
batlowS = batlowS_map
try:
    plt.colormaps.register(cmap=batlowS_map, name='batlowS')
except ValueError:
    pass  # Already registered

# turku
turku_data = [[6.3216e-05, 5.1671e-06, 3.583e-05],      
           ...
           [1, 0.89746, 0.89609],      
           [1, 0.90174, 0.90067]]
turku_map = LinearSegmentedColormap.from_list('turku', turku_data)
turku = turku_map
try:
    plt.colormaps.register(cmap=turku_map, name='turku')
except ValueError:
    pass  # Already registered

# turkuS
turkuS_data = [[0.029159, 0.028991, 0.026252],      
           [1, 0.90174, 0.90067],      
           [0.58704, 0.55558, 0.36149],      
           [0.30031, 0.29927, 0.23237],      
           [0.89781, 0.6685, 0.56633],      
           ...
           [0.30837, 0.30728, 0.23661],      
           [0.97251, 0.73978, 0.70702]]
turkuS_map = LinearSegmentedColormap.from_list('turkuS', turkuS_data)
turkuS = turkuS_map
try:
    plt.colormaps.register(cmap=turkuS_map, name='turkuS')
except ValueError:
    pass  # Already registered

# vikO
vikO_data = [[0.30979, 0.1009, 0.23843],      
...
vikO_map = LinearSegmentedColormap.from_list('vikO', vikO_data)
vikO = vikO_map
try:
    plt.colormaps.register(cmap=vikO_map, name='vikO')
except ValueError:
    pass  # Already registered

# broc
broc_data = [[0.17081, 0.10027, 0.29985],      
...
broc_map = LinearSegmentedColormap.from_list('broc', broc_data)
broc = broc_map
try:
    plt.colormaps.register(cmap=broc_map, name='broc')
except ValueError:
    pass  # Already registered

# batlowK
batlowK_data = [[0.010753, 0.014697, 0.019692],      
...
batlowK_map = LinearSegmentedColormap.from_list('batlowK', batlowK_data)
batlowK = batlowK_map
try:
    plt.colormaps.register(cmap=batlowK_map, name='batlowK')
except ValueError:
    pass  # Already registered

# batlowKS
batlowKS_data = [[0.018513, 0.030323, 0.04078],      
           [0.99074, 0.75313, 0.84424],      
           [0.51261, 0.48112, 0.20814],      
           [0.90582, 0.60722, 0.38711],      
           [0.22179, 0.33519, 0.3201],      
           ...
           [0.1053, 0.20632, 0.24391],      
           [0.1824, 0.30286, 0.3143]]
batlowKS_map = LinearSegmentedColormap.from_list('batlowKS', batlowKS_data)
batlowKS = batlowKS_map
try:
    plt.colormaps.register(cmap=batlowKS_map, name='batlowKS')
except ValueError:
    pass  # Already registered

# bam
bam_data = [[0.39622, 0.0081199, 0.29605],      
           ...
           [0.049098, 0.29666, 0]]
bam_map = LinearSegmentedColormap.from_list('bam', bam_data)
bam = bam_map
try:
    plt.colormaps.register(cmap=bam_map, name='bam')
except ValueError:
    pass  # Already registered

# tokyo
tokyo_data = [[0.10387, 0.056805, 0.20243],      
...
tokyo_map = LinearSegmentedColormap.from_list('tokyo', tokyo_data)
tokyo = tokyo_map
try:
    plt.colormaps.register(cmap=tokyo_map, name='tokyo')
except ValueError:
    pass  # Already registered

# tokyoS
tokyoS_data = [[0.10387, 0.056805, 0.20243],      
           [0.99708, 0.99733, 0.84887],      
           [0.56301, 0.52969, 0.52511],      
           [0.46223, 0.27624, 0.42457],      
           [0.63013, 0.77187, 0.5993],      
           ...
           [0.71178, 0.86509, 0.65474],      
           [0.43729, 0.24796, 0.40666]]
tokyoS_map = LinearSegmentedColormap.from_list('tokyoS', tokyoS_data)
tokyoS = tokyoS_map
try:
    plt.colormaps.register(cmap=tokyoS_map, name='tokyoS')
except ValueError:
    pass  # Already registered

# roma
roma_data = [[0.49232, 0.090787, 7.635e-05],      
...
roma_map = LinearSegmentedColormap.from_list('roma', roma_data)
roma = roma_map
try:
    plt.colormaps.register(cmap=roma_map, name='roma')
except ValueError:
    pass  # Already registered

# batlowW
batlowW_data = [[0.0046368, 0.098343, 0.34983],      
           ...
           [1, 0.99155, 0.99133],      
           [1, 0.99579, 0.99563]]
batlowW_map = LinearSegmentedColormap.from_list('batlowW', batlowW_data)
batlowW = batlowW_map
try:
    plt.colormaps.register(cmap=batlowW_map, name='batlowW')
except ValueError:
    pass  # Already registered

# batlowWS
batlowWS_data = [[1, 0.99579, 0.99563],      
           ...
           [0.064516, 0.25439, 0.37623],      
           [0.50229, 0.53307, 0.21432]]
batlowWS_map = LinearSegmentedColormap.from_list('batlowWS', batlowWS_data)
batlowWS = batlowWS_map
try:
    plt.colormaps.register(cmap=batlowWS_map, name='batlowWS')
except ValueError:
    pass  # Already registered

# nuuk
nuuk_data = [[0.018013, 0.35076, 0.55062],      
...
nuuk_map = LinearSegmentedColormap.from_list('nuuk', nuuk_data)
nuuk = nuuk_map
try:
    plt.colormaps.register(cmap=nuuk_map, name='nuuk')
except ValueError:
    pass  # Already registered

# nuukS
nuukS_data = [[0.018013, 0.35076, 0.55062],      
           [0.99624, 0.99617, 0.69898],      
           [0.62687, 0.64679, 0.59496],      
           [0.76407, 0.76242, 0.52329],      
           [0.32627, 0.46592, 0.52129],      
           ...
           [0.68862, 0.69245, 0.58121],      
           [0.94164, 0.94079, 0.62138]]
nuukS_map = LinearSegmentedColormap.from_list('nuukS', nuukS_data)
nuukS = nuukS_map
try:
    plt.colormaps.register(cmap=nuukS_map, name='nuukS')
except ValueError:
    pass  # Already registered

# lisbon
lisbon_data = [[0.90019, 0.89986, 0.99991],      
           ...
           [0.99987, 1, 0.84999]]
lisbon_map = LinearSegmentedColormap.from_list('lisbon', lisbon_data)
lisbon = lisbon_map
try:
    plt.colormaps.register(cmap=lisbon_map, name='lisbon')
except ValueError:
    pass  # Already registered

# oleron
oleron_data = [[0.10105, 0.15003, 0.35027],      
...
oleron_map = LinearSegmentedColormap.from_list('oleron', oleron_data)
oleron = oleron_map
try:
    plt.colormaps.register(cmap=oleron_map, name='oleron')
except ValueError:
    pass  # Already registered

# vanimo
vanimo_data = [[1, 0.80346, 0.99215],      
...
vanimo_map = LinearSegmentedColormap.from_list('vanimo', vanimo_data)
vanimo = vanimo_map
try:
    plt.colormaps.register(cmap=vanimo_map, name='vanimo')
except ValueError:
    pass  # Already registered

# lajolla
lajolla_data = [[0.99983, 0.99974, 0.79991],      
...
lajolla_map = LinearSegmentedColormap.from_list('lajolla', lajolla_data)
lajolla = lajolla_map
try:
    plt.colormaps.register(cmap=lajolla_map, name='lajolla')
except ValueError:
    pass  # Already registered

# lajollaS
lajollaS_data = [[0.99983, 0.99974, 0.79991],      
           [0.10023, 0.10091, 0.0037913],      
           [0.86973, 0.45582, 0.31068],      
           [0.94802, 0.76354, 0.37498],      
           [0.49809, 0.23315, 0.20576],      
           ...
           [0.93191, 0.69133, 0.33977],      
           [0.96044, 0.81711, 0.42301]]
lajollaS_map = LinearSegmentedColormap.from_list('lajollaS', lajollaS_data)
lajollaS = lajollaS_map
try:
    plt.colormaps.register(cmap=lajollaS_map, name='lajollaS')
except ValueError:
    pass  # Already registered

# buda
buda_data = [[0.70015, 0.0027445, 0.70061],      
           ...
           [1, 1, 0.4002]]
buda_map = LinearSegmentedColormap.from_list('buda', buda_data)
buda = buda_map
try:
    plt.colormaps.register(cmap=buda_map, name='buda')
except ValueError:
    pass  # Already registered

# budaS
budaS_data = [[0.70015, 0.0027445, 0.70061],      
           [1, 1, 0.4002],      
           [0.80548, 0.52274, 0.495],      
           [0.73557, 0.30688, 0.56485],      
           [0.86025, 0.74, 0.44036],      
           ...
           [0.71005, 0.22422, 0.59413],      
           [0.70409, 0.19203, 0.60791]]
budaS_map = LinearSegmentedColormap.from_list('budaS', budaS_data)
budaS = budaS_map
try:
    plt.colormaps.register(cmap=budaS_map, name='budaS')
except ValueError:
    pass  # Already registered

# corkO
corkO_data = [[0.24651, 0.24352, 0.2292],      
...
corkO_map = LinearSegmentedColormap.from_list('corkO', corkO_data)
corkO = corkO_map
try:
    plt.colormaps.register(cmap=corkO_map, name='corkO')
except ValueError:
    pass  # Already registered

# devon
devon_data = [[0.17103, 0.1004, 0.29978],      
...
devon_map = LinearSegmentedColormap.from_list('devon', devon_data)
devon = devon_map
try:
    plt.colormaps.register(cmap=devon_map, name='devon')
except ValueError:
    pass  # Already registered

# devonS
devonS_data = [[0.17103, 0.1004, 0.29978],      
           [0.97357, 0.97102, 0.9946],      
           [0.46541, 0.54531, 0.85481],      
           [0.15721, 0.33688, 0.55],      
           [0.77788, 0.75776, 0.95431],      
           ...
           [0.19213, 0.39459, 0.64477],      
           [0.17425, 0.37313, 0.60583]]
devonS_map = LinearSegmentedColormap.from_list('devonS', devonS_data)
devonS = devonS_map
try:
    plt.colormaps.register(cmap=devonS_map, name='devonS')
except ValueError:
    pass  # Already registered

# davos
davos_data = [[0, 0.019685, 0.29201],      
           [0, 0.027123, 0.29748],      
           [0, 0.034324, 0.30295],      
...
davos = davos_map
try:
    plt.colormaps.register(cmap=davos_map, name='davos')
except ValueError:
    pass  # Already registered

# davosS
davosS_data = [[0, 0.019685, 0.29201],      
           [0.99123, 0.99027, 0.95718],      
           [0.40896, 0.54645, 0.58144],      
           [0.6983, 0.75318, 0.56026],      
           [0.17713, 0.34467, 0.58337],      
           ...
           [0.68431, 0.74232, 0.55384],      
           [0.31676, 0.48209, 0.61244]]
davosS_map = LinearSegmentedColormap.from_list('davosS', davosS_data)
davosS = davosS_map
try:
    plt.colormaps.register(cmap=davosS_map, name='davosS')
except ValueError:
    pass  # Already registered

# bamako
bamako_data = [[0.0011753, 0.25004, 0.3],      
...
bamako_map = LinearSegmentedColormap.from_list('bamako', bamako_data)
bamako = bamako_map
try:
    plt.colormaps.register(cmap=bamako_map, name='bamako')
except ValueError:
    pass  # Already registered

# bamakoS
bamakoS_data = [[0.0011753, 0.25004, 0.3],      
           [0.9999, 0.89988, 0.59995],      
           [0.38057, 0.49296, 0.078304],      
           [0.16705, 0.35489, 0.20248],      
           [0.72588, 0.6474, 0.14503],      
           ...
           [0.96643, 0.86586, 0.53241],      
           [0.76475, 0.67721, 0.18823]]
bamakoS_map = LinearSegmentedColormap.from_list('bamakoS', bamakoS_data)
bamakoS = bamakoS_map
try:
    plt.colormaps.register(cmap=bamakoS_map, name='bamakoS')
except ValueError:
    pass  # Already registered

# fes
fes_data = [[0.049747, 0.049747, 0.049747],      
...
fes_map = LinearSegmentedColormap.from_list('fes', fes_data)
fes = fes_map
try:
    plt.colormaps.register(cmap=fes_map, name='fes')
except ValueError:
    pass  # Already registered

# oslo
oslo_data = [[0.0036704, 0.0050824, 0.0024536],      
           ...
           [0.9998, 1, 0.99996]]
oslo_map = LinearSegmentedColormap.from_list('oslo', oslo_data)
oslo = oslo_map
try:
    plt.colormaps.register(cmap=oslo_map, name='oslo')
except ValueError:
    pass  # Already registered

# osloS
osloS_data = [[0.011981, 0.022573, 0.035904],      
           [0.9755, 0.97627, 0.97736],      
           [0.30552, 0.47648, 0.73395],      
           [0.62419, 0.68501, 0.78985],      
           [0.087109, 0.22965, 0.36899],      
           ...
           [0.89657, 0.90052, 0.90736],      
           [0.047784, 0.084964, 0.12697]]
osloS_map = LinearSegmentedColormap.from_list('osloS', osloS_data)
osloS = osloS_map
try:
    plt.colormaps.register(cmap=osloS_map, name='osloS')
except ValueError:
    pass  # Already registered

# lapaz
lapaz_data = [[0.10352, 0.047787, 0.39353],      
...
lapaz_map = LinearSegmentedColormap.from_list('lapaz', lapaz_data)
lapaz = lapaz_map
try:
    plt.colormaps.register(cmap=lapaz_map, name='lapaz')
except ValueError:
    pass  # Already registered

# lapazS
lapazS_data = [[0.10352, 0.047787, 0.39353],      
           [0.99706, 0.94979, 0.95121],      
           [0.36082, 0.54989, 0.64017],      
           [0.17465, 0.32419, 0.57638],      
           [0.71002, 0.67743, 0.58847],      
           ...
           [0.23377, 0.43753, 0.62641],      
           [0.57952, 0.63694, 0.59553]]
lapazS_map = LinearSegmentedColormap.from_list('lapazS', lapazS_data)
lapazS = lapazS_map
try:
    plt.colormaps.register(cmap=lapazS_map, name='lapazS')
except ValueError:
    pass  # Already registered

# brocO
brocO_data = [[0.21429, 0.18467, 0.21821],      
...
brocO_map = LinearSegmentedColormap.from_list('brocO', brocO_data)
brocO = brocO_map
try:
    plt.colormaps.register(cmap=brocO_map, name='brocO')
except ValueError:
    pass  # Already registered

# hawaii
hawaii_data = [[0.55054, 0.006842, 0.45198],      
...
hawaii_map = LinearSegmentedColormap.from_list('hawaii', hawaii_data)
hawaii = hawaii_map
try:
    plt.colormaps.register(cmap=hawaii_map, name='hawaii')
except ValueError:
    pass  # Already registered

# hawaiiS
hawaiiS_data = [[0.55054, 0.006842, 0.45198],      
           [0.70378, 0.94898, 0.99377],      
           [0.61115, 0.58982, 0.11132],      
           [0.59051, 0.3043, 0.24172],      
           [0.41971, 0.83304, 0.55824],      
           ...
           [0.56224, 0.10313, 0.39747],      
           [0.61183, 0.47884, 0.13351]]
hawaiiS_map = LinearSegmentedColormap.from_list('hawaiiS', hawaiiS_data)
hawaiiS = hawaiiS_map
try:
    plt.colormaps.register(cmap=hawaiiS_map, name='hawaiiS')
except ValueError:
    pass  # Already registered

# tofino
tofino_data = [[0.87044, 0.84978, 0.99992],      
...
tofino_map = LinearSegmentedColormap.from_list('tofino', tofino_data)
tofino = tofino_map
try:
    plt.colormaps.register(cmap=tofino_map, name='tofino')
except ValueError:
    pass  # Already registered

# berlin
berlin_data = [[0.62108, 0.69018, 0.99951],      
...
berlin_map = LinearSegmentedColormap.from_list('berlin', berlin_data)
berlin = berlin_map
try:
    plt.colormaps.register(cmap=berlin_map, name='berlin')
except ValueError:
    pass  # Already registered

# romaO
romaO_data = [[0.45137, 0.22346, 0.34187],      
...
romaO_map = LinearSegmentedColormap.from_list('romaO', romaO_data)
romaO = romaO_map
try:
    plt.colormaps.register(cmap=romaO_map, name='romaO')
except ValueError:
    pass  # Already registered

# bukavu
bukavu_data = [[0.10021, 0.20003, 0.20006],      
...
bukavu_map = LinearSegmentedColormap.from_list('bukavu', bukavu_data)
bukavu = bukavu_map
try:
    plt.colormaps.register(cmap=bukavu_map, name='bukavu')
except ValueError:
    pass  # Already registered
...
grayC_map = LinearSegmentedColormap.from_list('grayC', grayC_data)
grayC = grayC_map
try:
    plt.colormaps.register(cmap=grayC_map, name='grayC')
except ValueError:
    pass  # Already registered

# grayCS
grayCS_data = [[0.97775, 0.97775, 0.97775],      
           [0.022447, 0.022447, 0.022447],      
           [0.4644, 0.4644, 0.4644],      
           [0.71029, 0.71029, 0.71029],      
           [0.24026, 0.24026, 0.24026],      
           ...
           [0.067013, 0.067014, 0.067014],      
           [0.51517, 0.51517, 0.51517]]
grayCS_map = LinearSegmentedColormap.from_list('grayCS', grayCS_data)
grayCS = grayCS_map
try:
    plt.colormaps.register(cmap=grayCS_map, name='grayCS')
except ValueError:
    pass  # Already registered

# bamO
bamO_data = [[0.30946, 0.18635, 0.26374],      
...
bamO_map = LinearSegmentedColormap.from_list('bamO', bamO_data)
bamO = bamO_map
try:
    plt.colormaps.register(cmap=bamO_map, name='bamO')
except ValueError:
    pass  # Already registered

# acton
acton_data = [[0.18063, 0.12992, 0.30024],      
...
acton_map = LinearSegmentedColormap.from_list('acton', acton_data)
acton = acton_map
try:
    plt.colormaps.register(cmap=acton_map, name='acton')
except ValueError:
    pass  # Already registered

# actonS
actonS_data = [[0.18063, 0.12992, 0.30024],      
           [0.90047, 0.90012, 0.94005],      
           [0.76786, 0.4312, 0.60779],      
           [0.46779, 0.35109, 0.52396],      
           [0.82977, 0.65598, 0.77186],      
           ...
           [0.89742, 0.89195, 0.93448],      
           [0.35764, 0.28079, 0.45243]]
actonS_map = LinearSegmentedColormap.from_list('actonS', actonS_data)
actonS = actonS_map
try:
    plt.colormaps.register(cmap=actonS_map, name='actonS')
except ValueError:
    pass  # Already registered

__all__ = ['bilbao', 'bilbaoS', 'imola', 'imolaS', 'vik', 'cork', 'batlow', 'batlowS', 'turku', 'turkuS', 'vikO', 'broc', 'batlowK', 'batlowKS', 'bam', 'tokyo', 'tokyoS', 'roma', 'batlowW', 'batlowWS', 'nuuk', 'nuukS', 'lisbon', 'oleron', 'vanimo', 'lajolla', 'lajollaS', 'buda', 'budaS', 'corkO', 'devon', 'devonS', 'davos', 'davosS', 'bamako', 'bamakoS', 'fes', 'oslo', 'osloS', 'lapaz', 'lapazS', 'brocO', 'hawaii', 'hawaiiS', 'tofino', 'berlin', 'romaO', 'bukavu', 'grayC', 'grayCS', 'bamO', 'acton', 'actonS']
